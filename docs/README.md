# 📚 Documentation & Feuille de Route — ComicStream

Ce dossier contient toute la documentation technique, le contexte d'exécution et le plan de développement du projet **ComicStream**.
...
2. **[📖 CONTEXT.md](file:///root/perso/comic_reader_app/docs/CONTEXT.md)** :  
   Spécifications de l'environnement matériel (tablette Huawei MediaPad M5 Lite 10.1"), infrastructure serveur FTP (Raspberry Pi `192.168.1.12`), formats supportés et état actuel des fonctionnalités.
