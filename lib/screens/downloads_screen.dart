                    ...
                    if (activeTasks.isNotEmpty) ...[
                      ...
                      for (final task in activeTasks)
                        _buildActiveTaskCard(
                            context, task, downloadProvider, theme),
                      const SizedBox(height: 16),
                    ],
        ...
        children: [
          Row(
            children: [
              ...
              IconButton(
                icon:
                    const Icon(Icons.close, size: 20, color: Colors.redAccent),
  ...
  Widget _buildCompletedTaskCard(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border:
            Border.all(color: theme.colorScheme.outlineVariant.withAlpha(25)),
      ),
      child: Row(
        children: [
          Container(
              ...
              onPressed: () {
                ...
                if (book != null) {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                        builder: (_) => buildSyncedReaderScreen(book)),
                  );
                }
              },
